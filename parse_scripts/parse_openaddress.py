...
# this determines the ordering of training xml tags, & the mapping of address
# strings xml address tag, whether raw data has this tag, corresponding json
# tag in raw data or predetermined value
tag_mapping = [
